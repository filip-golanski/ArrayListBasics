...
public class HandOfPlayingCardsRun {
   ...
   public static void main(String[] args) { 
       int seed = 99;		// either 44 or 99
       // TODO: Implement your code here
       Deck deck = new Deck(1,seed);
       Hand hand = new Hand();
       System.out.println("Random Number Seed: "+seed);
       System.out.println("Deck("+deck.cardCount()+")\t: "+deck.toString());
       deck.shuffle();
       System.out.println("Shuffled("+deck.cardCount()+")\t: "+deck.toString());
       for(int i=0; i<5; i++)
       {
    	   hand.add(deck.deal());
       }
       System.out.println("Your Hand\t: "+hand.toString()+"Remaining Deck("+deck.cardCount()+")\t: "+deck.toString());
       System.out.println("Pair of Queens? "+(hand.rankCount(10)==2));
       System.out.println("Three Kings? "+(hand.rankCount(11)==3));
