...
public class Board {
	...
	public boolean Winner(Marker marker) {
		...
		for(int i=0; i<3; i++)
		{
			if (this.board[i][0] == Marker.O && this.board[i][1] == Marker.O && this.board[i][2] == Marker.O
				|| this.board[i][0] == Marker.X && this.board[i][1] == Marker.X && this.board[i][2] == Marker.X)
			{
				rowWinner = true;
			}
		}
		...
		for(int i=0; i<3; i++)
		{
			if (this.board[0][i] == Marker.O && this.board[1][i] == Marker.O && this.board[2][i] == Marker.O
				|| this.board[0][i] == Marker.X && this.board[1][i] == Marker.X && this.board[2][i] == Marker.X)
			{
				colWinner = true;
			}
		}
		if (this.board[0][0] == Marker.O && this.board[1][1] == Marker.O && this.board[2][2] == Marker.O
				|| this.board[0][0] == Marker.X && this.board[1][1] == Marker.X && this.board[2][2] == Marker.X)
		{
			angleWinner = true;
		}
		
		if (this.board[2][0] == Marker.O && this.board[1][1] == Marker.O && this.board[0][2] == Marker.O
				|| this.board[2][0] == Marker.X && this.board[1][1] == Marker.X && this.board[0][2] == Marker.X)
		{
			angleWinner = true;
		}
